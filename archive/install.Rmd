...
knitr::include_graphics("fig/install_package.png")
```
...
```{r  echo=FALSE, out.width = '100%'}
knitr::include_graphics("fig/install_package2.png")
```
...
```{r  echo=FALSE, out.width = '100%'}
knitr::include_graphics("fig/libary_loaded.png")
```
...
```{r  echo=FALSE, out.width = '100%'}
knitr::include_graphics("fig/download-repo.PNG")
```
